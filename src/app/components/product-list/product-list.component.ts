...
export class ProductListComponent implements OnInit {
  products: Product[] = [];
  currentCategoryId: number = 1; // Assign a default value to 'currentCategoryId'
  ...
  handledListProduct() {
    ...
    //route->use the activated route , snapshot->state of route at this given momnet in time
    //paramMap->map of all routes parameters
